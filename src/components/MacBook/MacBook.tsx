...
// 1. Explicitly map out every named mesh node and material inside your mac-draco GLTF file
type GLTFResult = {
  nodes: {
    Cube008: THREE.Mesh;
...
// 2. Strongly type the component argument with the global inline JSX registry
export function MacBook(props: JSX.IntrinsicElements["group"]) {
  // Double-cast useGLTF safely to bind our specific structural keys
